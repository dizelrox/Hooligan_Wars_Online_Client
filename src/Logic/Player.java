 ...
 * This class used to create different characters both for computer and the
 * user.<br>
 * Instance of this object holds all the information about the character:its
 * name,icons<br>
 * attack and defence factors,currently wearing items,health and desired attack
 * and defend areas.<br>
...
public class Player implements Serializable
{
    ...
    /**
     * This variable holds an {@linkplain Icon} that displaying player in
     * {@linkplain CharacterFrame}.<br>
     * Does not refer to bot.
     */
    private Icon shopIcon;
    /**
     * This variable holds an {@linkplain Icon} that is displayed in
     * {@linkplain BattleForm}.
     */
    private Icon battleIcon;
    /**
     * This integer variable represents basic attack damage that each player
     * have even without weapon.
     */
    private int strengthFactor;
    /**
     * This double variable represents basic defense rate that each player have
     * even without armor.
     */
    private double defenceFactor;
    /**
     * Variable that holds array of {@linkplain Item}s that each character is
     * currently wearing.
     */
    ...
    /**
     * Console text generated for each played during the battle describing its
     * progress.
     */
    private String consoleText;
    /**
     * Holds the current availability of the armor items in stock for the
     * player.
     *
     * @see (@linkplain Armor)
     */
    ...
    /**
     * Holds the current availability of the weapon items in stock for the
     * player.
     *
     ...
     * Not all the fields of the player are being initialized here but only the
     * basic ones.<br>
     * All other properties are set by the user though
     * {@linkplain CrahacterFrame} window.
     *
     ...
     * In this constructor all the properties of the object are filled
     * randomally to make each bot different.<br>
     *
     * @param wepArr array of type {@linkplain Weapon} that represents all the
     * weapons in game that the bot can choose from.
     * @param armArr array of type {@linkplain Armor} that represents all the
     * armors in game that the bot can choose from.
     */
    ...
    /**
     * Updates the current array of items according to the (@linkplain Item)s
     * array located in the (@linkplain GameInitialize) object
     *
     * @param armArray
     * @param wepArray
     */
    ...
    /**
     * <h2>Method used to generate user's player statistics.</h2>Based on
     * currently wearing {@linkplain Item}s<br>
     * and basic strength and defense factor.<br>
     * Displayed in {@linkplain CharacterFrame}
     *
     * @return String variable containing all the information about player's
     * statistics.
     */
    public String getStats()
    {
        ...
        while (iterator.hasNext())
        {
            ...
            if (singleItem.getClass() == Armor.class)
            {
     ...
     * area.
     * @param target receives instance of class {@linkplain Player} which is the
     ...
     *
     * @param area receives {@linkplain Type} that will be set as player's
     * defense area.
     */
